  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 90px)' }} className="w-full flex justify-center items-center py-12 lg:py-24">
      <div className="w-96 md:w-[420px] border  p-8 space-y-3 rounded-xl bg-[var(--clr-light-gray)]">
       ...
       {/* Google Login field */}
       <div className="w-full px-4 py-2 rounded-md hover:rounded-full border border-[var(--clr-primary)] flex items-center justify-center gap-2 cursor-pointer duration-300 font-bold my-6" onClick={handleGoogleLogin}>
       <FcGoogle className="text-2xl"/> <span>Login with google</span>
        </div>

       </div>
        <div className="flex items-center justify-center gap-4">
          <div className="h-[1px] bg-[var(--clr-primary)] w-1/12 md:w-1/4"></div>
            <p>or Login with</p>
            <div className="h-[1px] bg-[var(--clr-primary)] w-1/12 md:w-1/4"></div>
        </div>
        ...
        <p className="text-center text-sm flex justify-center gap-2 pt-2">
          Not registered yet? 
         <Link to="/register" className="flex gap-1 text-[var(--clr-primary)] font-bold">
